# trade_nifty_index_listener.py
import sys
import threading
from os import access

from trade_nifty_index import connect_fyers_websocket_nifty
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        #print("Usage: python trade_nifty_index_listener.py <full_access_token>")
        sys.exit(1)
